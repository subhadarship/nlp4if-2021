"""Code is taken from https://gitlab.com/NLP4IF/nlp4if-2021/-/blob/master/format_checker/main.py"""
...
if __name__ == "__main__":
    ...
    parser.add_argument("--pred_file_path", "-p", required=True,
                        help="The absolute path to the file you want to check.", type=str)
